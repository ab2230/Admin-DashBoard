...
const BookCollectionForm = ({inputs,title,url}) => {

  const [file,setFile] = useState("");
  const [formValues,setFormValues] = useState([{ file:"", chapterName: "", chapterLength : "", description2:""}])
  ...
  let addFormFields = () => {
      setFormValues([...formValues, { file:"", chapterName: "", chapterLength : "",description2:""}])
    }
            ...
            <div className="form-inline" key={index}>
              <div className="formInput">
                  ...
                  <div className="formInput">
                    ...
                    <input type='text' name='chapterName' placeholder="chapter name" value={formValue.chapterName||''} onChange={e => handleChange(index, e)} />
                  </div>

                  <div className="formInput">
                    <label>Chapter Length</label>
                    <input type='text' name='chapterLength' placeholder="chapter length" value={formValue.chapterLength ||''} onChange={e => handleChange(index, e)} />
                  </div>
...
export default BookCollectionForm
